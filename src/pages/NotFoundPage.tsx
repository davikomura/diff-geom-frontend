...
export const NotFoundPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-gray-100 px-6 relative overflow-hidden">
      <title>404 - {t("notFound.title")} | ManifoldSim 3D</title>
      <meta name="description" content={t("notFound.description")} />
      <meta property="og:title" content={`404 - ${t("notFound.title")} | ManifoldSim 3D`} />
      <meta property="og:description" content={t("notFound.description")} />
      <meta property="og:image" content="/logo/ManifoldSim3d.png" />
      <meta property="twitter:title" content={`404 - ${t("notFound.title")} | ManifoldSim 3D`} />
